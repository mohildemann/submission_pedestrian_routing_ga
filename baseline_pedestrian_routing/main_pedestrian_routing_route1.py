...
def main_route_1( search_space_definition, pop_size, initialization = False):
    if search_space_definition == "distance_only":
        search_space = uls.preprocess_excel(r'../input_edges/possible_edges_studyarea.xlsx')
    elif search_space_definition == "combined_score":
        search_space =  uls.preprocess_excel_w_scores(r'../input_edges/global_local_scores_50_percent.xlsx')
    elif search_space_definition == "local_score":
        search_space = uls.preprocess_excel_w_scores(r'../input_edges/local_scores_50_percent.xlsx')
    else:
        search_space = uls.preprocess_excel_w_scores(r'../input_edges/global_scores_50_percent.xlsx')
    ...
    if initialization == False:
        with open(r'..\initial_population\pop_309_3211_100.pkl', 'rb') as file_object:
    ...
    problem_instance = network.Network(search_space=search_space, fitness_function=uls.sum_node_distances,start_node_id = 309, end_node_id= 3211, minimization=True)
