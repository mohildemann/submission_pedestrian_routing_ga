...
def main_route_3( search_space_definition,pop_size, initialization = False):
    ...
    if initialization == False:
        with open(r'..\initial_population\pop_1815_3211_100.pkl', 'rb') as file_object:
    ...
    problem_instance = network.Network(search_space=search_space, fitness_function=uls.sum_node_distances,start_node_id = 1815, end_node_id= 3211, minimization=True)
